      ...
      <div className={`col-lg-${this.props.col ? this.props.col : '4'} col-md-12`}>
        <div className='woocommerce-sidebar-area'>
          ...
          <div className={`collapse-widget collections-list-widget ${collection ? '' : 'open'}`}>
            <h3 className={`collapse-widget-title ${collection ? '' : 'active'}`} onClick={(e) => this.handleToggle(e, 'collection')}>
              Collections
              <i className='fas fa-angle-up'></i>
            </h3>
          ...
          <div className={`collapse-widget brands-list-widget ${brand ? '' : 'open'}`}>
            <h3 className={`collapse-widget-title ${brand ? '' : 'active'}`} onClick={(e) => this.handleToggle(e, 'brand')}>
              Brands
              <i className='fas fa-angle-up'></i>
            </h3>
          ...
          <div className={`collapse-widget size-list-widget ${size ? '' : 'open'}`}>
            <h3 className={`collapse-widget-title ${size ? '' : 'active'}`} onClick={(e) => this.handleToggle(e, 'size')}>
              Size
              <i className='fas fa-angle-up'></i>
            </h3>
          ...
          <div className={`collapse-widget price-list-widget ${price ? '' : 'open'}`}>
            <h3 className={`collapse-widget-title ${price ? '' : 'active'}`} onClick={(e) => this.handleToggle(e, 'price')}>
              Price
              <i className='fas fa-angle-up'></i>
            </h3>
          ...
          <div className={`collapse-widget color-list-widget ${color ? '' : 'open'}`}>
            <h3 className={`collapse-widget-title ${color ? '' : 'active'}`} onClick={(e) => this.handleToggle(e, 'color')}>
              Color
              <i className='fas fa-angle-up'></i>
            </h3>
          ...
          <div className={`collapse-widget tag-list-widget ${popular ? '' : 'open'}`}>
            <h3 className={`collapse-widget-title ${popular ? '' : 'active'}`} onClick={(e) => this.handleToggle(e, 'popular')}>
              Popular Tags
              <i className='fas fa-angle-up'></i>
            </h3>
